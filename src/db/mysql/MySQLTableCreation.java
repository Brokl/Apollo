...
public class MySQLTableCreation {
	...
	public static void main(String[] args) {
		try {
			...
			try {
				System.out.println("Connecting to " + MySQLDBUtil.URL); // for debugging
			...
			// the sequence is important because there is foreign key in history table
			// how about changing sequence between category and history ???
			...
			// You have to set item_id NOT NULL then set it PRIMARY KEY successfully.
			// Step 3. Create new tables.
			// Step 3. Create new tables.
